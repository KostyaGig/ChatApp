...
interface JoinUiStates : UiStates, AbstractModel<JoinUiStates>, IsNotEmpty<Unit> {
    ...
    fun textIsNotEmpty() = false

    data class Base(
        private val userNickName: JoinUiState.UserNickName = JoinUiState.UserNickName(""),
        private val userProfileImage: JoinUiState.UserImageProfile = JoinUiState.UserImageProfile(ImageProfile.Empty)
    ) : JoinUiStates {
        ...
        override fun textIsNotEmpty(): Boolean = userNickName.isNotEmpty(Unit)
    }
